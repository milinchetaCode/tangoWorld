    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                ...
                const response = await fetch(getApiUrl('/events/mine'), {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 bg-slate-50 min-h-screen">
            ...
            <div className="mt-8">
                ...
                <div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    {myEvents.length === 0 && (
                        <div className="col-span-full text-center py-12 bg-white rounded-2xl ring-1 ring-slate-200 border-2 border-dashed border-slate-200">
